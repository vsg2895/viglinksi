 ...
 */
export const alt = 'Viglinksi — Audited Casino Reviews'
    ...
    (
      ...
      >
        <div style={{ fontSize: 40, letterSpacing: 10, opacity: 0.85, textTransform: 'uppercase' }}>
          Audited Casino Reviews
        </div>
        <div style={{ fontSize: 104, fontWeight: 700, marginTop: 24, textAlign: 'center', padding: '0 60px', color: '#e6c37e' }}>
          Viglinksi
        </div>
